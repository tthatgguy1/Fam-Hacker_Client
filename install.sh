...
#Update Packages
echo -e "\e[32m" "Updating default packages\n"
pkg update && pkg upgrade -y >/dev/null 2>/dev/null
sleep 3

#Install Aria2 Termux
echo -e "\e[32m" "Installing Required Packages\n"
pkg install aria2 -y >/dev/null 2>/dev/null
sleep 2
